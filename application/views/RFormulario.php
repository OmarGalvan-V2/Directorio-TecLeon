                    ...
                    $.ajax({
                        ...
                        success: function(resp) {
                            if (resp == 'Error') {
                                ...
                                Swal.fire({
                                    title: 'El Profesor ha sido registrado correctamente!',
                                    text: 'Click para continuar!',
                                    icon: 'success'
                                }).then(() => {
                                    window.location.href =
                                        'http://localhost/CopiaTec/Welcome/Administracion'
                                });
                            }
                        }
                    });
    ...
    <div class="container-fluid px-1 px-md-5 px-lg-1 px-xl-5 py-5 mx-auto" style="margin-top: 50px;">
        <div class="card2 card0 border-0">
            <div class="d-flex justify-content-center pb-5">
                <img src=<?= base_url() . "images/CapyProfe.jpg" ?> class="image rounded-circle" style="width:280px; transform: translateY(5%);">
            </div>
            <div>
                <div>
                    <div>
                        <form id="FormR" action=<?= base_url() . "CRUDEP/InsertarDatos" ?> method="POST">
                            ...
                            <div class="form-group col-sm-6 mx-auto" style="max-width: 350px; padding-bottom: 7px;">
                                <div class="input-group-prepend">
                                    ...
                                    <input type="text" class="form-control" id="Cubiculo" name="Cubiculo" placeholder='Cubiculo' value="<?php echo set_value('Cubiculo'); ?>" size="3">
                                    <small class="invalid-feedback"></small>
                                </div>
                            </div>
                                ...
                                <div class="input-group-prepend">
                                    ...
                                    <select class="form-control" id="Turno" name='Turno'>
                                        <?php for ($i = 0; $i < count($Datos); $i++) { ?>
                                            <option value="<?= $Datos[$i]['ID'] ?>"><?= $Datos[$i]['Turno'] ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group col-sm-6 mx-auto" style="max-width: 350px;margin-top: -20px;">
                                <div class="input-group-prepend">
                                    ...
                                    <select class="form-control" id="Departamento" name='Departamento'>
                                        <?php for ($i = 0; $i < count($Datos3); $i++) { ?>
                                            <option value="<?= $Datos3[$i]['ID'] ?>"><?= $Datos3[$i]['Departamentos'] ?>
                                            </option>
                                        <?php } ?>
                                    </select>
                                </div>
