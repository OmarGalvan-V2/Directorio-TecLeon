                    ...
                    $.ajax({
                        ...
                        success: function(resp) {
                            if (resp == 'Error') {
                                ...
                                Swal.fire({
                                    title: 'El Directivo departamental ha sido actualizado correctamente!',
    ...
    <div class="container-fluid px-1 px-md-5 px-lg-1 px-xl-5 py-5 mx-auto" style="margin-top: 50px;">
        <div class="card2 card0 border-0">
            <div class="d-flex justify-content-center pb-5">
                <img src=<?= base_url() . "images/CapyDepartamental.jpg" ?> class="image rounded-circle" style="width:300px">
            </div>
            <div>
                <div>
                    <div>
                        <form id="FormR" action="<?= base_url() ?>CRUDEP/ActualizarDDD?id=<?= $Directivo[0]['ID'] ?>" method="POST">
                            ...
                            <div class="form-group col-sm-6 mx-auto" style="max-width: 380px; padding-bottom: 7px">
                                <div class="input-group-prepend">
                                    ...
                                    <input type="text" class="form-control" id="NombreDept" name="NombreDept" placeholder="Nombre" value="<?= $Directivo[0]['NombreDept'] ?>">
                            ...
                            <div class="form-group col-sm-6 mx-auto" style="max-width: 380px;padding-bottom: 7px">
                                <div class="input-group-prepend">
                                    ...
                                    <input type="text" class="form-control" id="JefeDept" name="JefeDept" placeholder="Jefe Departamental" value="<?= $Directivo[0]['JefeDept'] ?>">
                                    <small class="invalid-feedback"></small>
                                </div>
                            </div>
                            ...
                            <div class="form-group col-sm-6 mx-auto" style="max-width: 380px; padding-bottom: 7px">
                                <div class="input-group-prepend">
                                    ...
                                    <input type="text" class="form-control" id="CorreoDept" name="CorreoDept" placeholder='Correo' value="<?= $Directivo[0]['CorreoDept'] ?>" size="50">
                                    <small class="invalid-feedback"></small>
                                </div>
                            </div>
                            ...
                            <div class="form-group col-sm-6 mx-auto" style="max-width: 380px;margin-top: -20px;">
                                <div class="input-group-prepend">
                                    ...
                                    <?php $departamento_seleccionado = $Directivo[0]['Edificio'] ?>
                            ...
                            <div class='d-flex justify-content-center'>
                                <button type="submit" class="btn btn-outline-primary mx-5 Enviar"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-fill-check" viewBox="0 0 16 16">
